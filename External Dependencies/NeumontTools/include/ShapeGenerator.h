...
namespace Neumont
{
	...
	public:
		...
		// Render GL_TRIANGLES
		static ShapeData makePlane(uint width, uint height);
		// Render GL_LINES
	...
	private:
		...
		static ShapeData makePlaneVerts(uint width, uint height);
		static ShapeData makePlaneIndices(uint width, uint height);
		static ShapeData makePlaneUnseamedIndices(uint tesselation);
		static void findMinMaxPoints(ShapeData& shapeData);
		static void calculateTangents(ShapeData& shapeData);
